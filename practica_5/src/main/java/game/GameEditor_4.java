...
public class GameEditor_4 extends JFrame implements KeyListener {
    ...
    ArrayList<IGameObject> gameObjects = new ArrayList<>(); //Lista de objetos de game
    int itemsCounter;
        ...
        btAddClover.addActionListener(
            new ActionListener(){
                ...
                public void actionPerformed(ActionEvent ae){
                    ...
                    gameObjects.add(new Blossom(new Position(col, row), 10, 1)); //Se añade elemento a la lista
                    printGameItems();
                ...
                public void actionPerformed(ActionEvent ae){
                    ...
                    if (jArray != null){
                        ...
                        for (int i = 0; i < jArray.length(); i++){
                            ...
                            gameObjects.add(GameObjectsJSONFactory.getGameObject(jObj));//GameObjectJSONFactory permite cargar un fichero de objetos JSON
                        }
                        printGameItems(); 
                        canvas.drawGameItems(gameObjects);
                    }
