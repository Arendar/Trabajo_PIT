 ...
 * @author juanangel
 */
public class GameEditor_5 extends JFrame implements KeyListener {
    ...
    // Declare new buttons
    JButton btAddClover, btAddDandelion,btAddBee,btAddFly, btClear;
    ...
    public GameEditor_5() throws Exception{
        ...
        btAddBee = new JButton("Bee");
        btAddBee.addActionListener(
            new ActionListener(){
                @Override
                public void actionPerformed (ActionEvent ae){
                    System.out.println("Bee selected");
                    gameObjects.add(new Bee(new Position(col, row), 3));
                    printGameItems();
                    canvas.drawGameItems(gameObjects);
                    requestFocusInWindow();
                }
        ...
        btAddFly = new JButton("Fly");
        btAddFly.addActionListener(
            new ActionListener(){
                @Override
                public void actionPerformed (ActionEvent ae){
                    System.out.println("Fly selected");
                    gameObjects.add(new Fly(new Position(col, row), 1));
                    printGameItems();
                    canvas.drawGameItems(gameObjects);
                    requestFocusInWindow();
                }
        ...
        pnButtons.add(btAddBee);
        pnButtons.add(btAddFly);
    ...
    public static void main(String [] args) throws Exception{
       GameEditor_5 gui = new GameEditor_5();
    }
    ...
    class Canvas extends JPanel {
        ...
        public void paintComponent(Graphics g){
            ...
            try {
                ...
                Logger.getLogger(GameEditor_5.class.getName()).log(Level.SEVERE, null, ex);
            }
        }     
        ...
        private void drawGameItems(Graphics g) throws Exception{
            ...
            BoxesFactory box = new BoxesFactory();

            
            if (objects != null){
                for (IGameObject obj: objects){
                    if (obj != null){
                        view= box.getView(obj, boxSize);
                        view.draw(g);
                    }
                }
            }
